...
require (
	...
	github.com/je4/mediaserverimage/v2 v2.0.0-20240526190230-76b0b9c00031
...
require (
	...
	github.com/je4/filesystem/v2 v2.0.13 // indirect
	github.com/je4/mediaserveraction/v2 v2.0.1 // indirect
